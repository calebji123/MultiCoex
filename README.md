...
MultiCoex is a package to analyze and interperet differential
coexpression data. This occurs when coexpression data is created for
specific tissues, conditions, or developmental states. Identifying
consistent and differential gene communities throughout the conditions,
highlighting regulatory elements and changes in regulatory structures.
Based on the algorithms described in Russell et al. (2023), MultiCoex
aims to provide the first implementation of differential coexpression
analysis using multilayered networks in an R package, with smooth
integration with coexpression pipelines and visualization tools. This
package was developed for BCB410H (Applied Bioinformatics) course at the
University of Toronto. It was developed using
`R version 4.5.1 (2025-06-13)`, `Platform: aarch64-apple-darwin20` and
`Running under: macOS Sequoia 15.5`.

## Installation

You can install the development version of MultiCoex from
...
Take a look at the vignette for a quick tutorial on how to use the
package:
...
- Russell, M., Aqil, A., Saitou, M., Gokcumen, O., Masuda, N. (2023).
  Gene communities in co-expression networks across different tissues.
  PLoS Comput Biol, 19(11).
...
CANADA. MultiCoex welcomes issues, enhancement requests, and other
